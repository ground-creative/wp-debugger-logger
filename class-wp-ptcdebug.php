<?php
	...
	class WP_PtcDebug extends PtcDebug
	{
		...
		// override parent fucntion to add time to WP QUERIES
		...
		public static function adminPage( ) 
		{
			...
			$show_w3c['attributes['.$data['show_w3c'].']']=array('checked'=>true);
			$form->addElement($show_w3c);
			...
			$minified_html['attributes['.$data['minified_html'].']']=array('checked'=>true);
			$form->addElement($minified_html);
			...
			$code_coverage['attributes['.$data['code_coverage'].']']=array('checked'=>true);
			$form->addElement($code_coverage);
			
			$trace_functions=array
			(
				'type'			=>		'radiogroup',
			...
			$trace_functions['attributes['.$data['trace_functions'].']']=array('checked'=>true);
			$form->addElement($trace_functions);
			...
			echo '<a style="margin-left:20px" href="http://phptoolcase.com/guides/ptc-debug-guide.html" target="_blank">Visit home page for usage and informations</a>';
			echo '</div>';
			...
			$html_final=str_replace('style="width:59%;" cols="3"','style="width:48%;" cols="3"',$html_final);
			echo $html_final;
			echo '</div>';
			echo '<div>';
			echo '<div style="height:88px;"><!-- --></div><br>';
			echo 'WP_DEBUG: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>'.
